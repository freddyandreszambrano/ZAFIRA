...
class AppTheme {
  ThemeData getThemeData(BuildContext context) {
    ...
    final onEnvironmentColor =
        isDev ? context.appPalette.black : context.appPalette.primary;

    final onEnvironmentContainerColor =
        isDev ? context.appColors.grayDark : context.appPalette.primaryDark;

    final statusBarColor = onEnvironmentColor;

    final statusBarIconTextColor =
        isDev ? context.appPalette.surface : context.appPalette.surface;
    ...
    return ThemeData(
      ...
      tabBarTheme:
          TabBarThemeData(indicatorColor: context.appPalette.secondary),

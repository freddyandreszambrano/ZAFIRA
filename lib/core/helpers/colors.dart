...
class _AppColors {
  ...
  static const MaterialColor primary = MaterialColor(_primaryBase, <int, Color>{
    50: Color(0xFFFFE5F6),
  ...
  static const MaterialColor secondary =
      MaterialColor(_secondaryBase, <int, Color>{
        50: Color(0xFFEFE7FF),
  ...
  static const MaterialColor error = MaterialColor(_errorBase, <int, Color>{
    50: Color(0xFFFEE2E2),
  ...
  static const MaterialColor success = MaterialColor(_successBase, <int, Color>{
    50: Color(0xFFDCFCE7),
  ...
  static const MaterialColor information =
      MaterialColor(_informationBase, <int, Color>{
        50: Color(0xFFE0F2FE),
  ...
  static const MaterialColor neutral = MaterialColor(_neutralBase, <int, Color>{
    50: Color(0xFFF8FAFC),
